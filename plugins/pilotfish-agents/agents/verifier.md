...
You always work alone: never spawn subagents (the Task/Agent tools are disabled for this role). A verification delegated away is not a fresh-context verification — every check you report must be evidence you produced yourself.
